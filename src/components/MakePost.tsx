...
export default function MakePost() {
  ...
  const renderLoadingUi = isRegionTownLoading || isCategoriesLoading || isUserLoading;
  ...
  return (
    <div className="w-full min-h-screen">
      ...
      <div className="w-full max-w-3xl mx-auto px-4 py-8 md:py-12">
       ...
       {renderLoadingUi &&  <BeatLoaderUI color="blue" size={12} className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2" /> }
        {/* STEP 1 FORM */}
        <form onSubmit={handleSubmit(onSubmit)} >
          <section className={`${renderNextPage ? "hidden" : "block"} ${renderLoadingUi && 'pointer-events-none opacity-20'}`}>
