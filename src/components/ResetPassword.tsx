...
export default function ResetPassword() {
    ...
    const {register, handleSubmit, getValues,formState:{ isSubmitting , errors}} = useForm<ResetUserPassword>({
        mode: "onBlur",
        defaultValues:{
           emailOrPhone: "",
           password: ""
    ...
    const submitResetForms: SubmitHandler<ResetUserPassword> = async(data)=>{
            try {
                const res = await fetch("/api/account/me/reset/password", {
                    ...
                    credentials: "include",
                    headers: { "Content-Type": "application/json" },
                    body: JSON.stringify({ emailOrPhone: data.emailOrPhone, otpCode: data.otpCode, newPassword: data.password}),
                });
                              ...
                              <div>
                                  ...
                                  <div>
                                      ...
                                      />
                                          ...
                                          >
                                              {loading ? (
                                                    counterLoading ?  `${countDown} sec.` : <Spinner />
                                              ) : (
