...
export default function VerificationRequests() {
    ...
    const {data, isLoading} = useSWR("/api/workspace/users/verificationRequests", fetcher);

    return (
        <div className="w-full max-w-full px-6 pt-8">
            <div className="flex flex-col justify-start gap-8">
                <div className="w-fit">
                    <h1 className="text-2xl text-gray-700"> Verification Requests </h1>
                </div>
                ...
                { isLoading ? "Loading..." :
                    <div className="flex flex-col justify-start gap-8">
                        ...
                        <div className="flex justify-start gap-4">
                            ...
                            <div className="rounded-md bg-[#DCBFFF] px-5 py-5 w-full max-w-full h-fit border">
                                <p className="text-black font-bold text-3xl mb-1.5">{data?.length}</p>
                                <p className="text-gray-600 text-sm tracking-wide">Awaiting verification request</p>
                            </div>
                            ...
                            <div className="rounded-md bg-[#ffff] px-5 py-5 w-full max-w-full h-fit border ">
                                ...
                                <p className="text-gray-600 text-sm tracking-wide">Rejected verification</p>
                            </div>

                            <div className="rounded-md bg-[#ffff] px-5 py-5 w-full max-w-full h-fit border opacity-0">
                                <p className="text-black font-bold text-3xl mb-1.5">{`582`}</p>
