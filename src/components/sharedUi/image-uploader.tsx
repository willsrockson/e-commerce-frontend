...
export default function ImageUploader({ control, name, min, max , errorMessage, warningUi}: ImageUploaderProps) {

//     const mouseSensor = useSensor(MouseSensor, {
//     activationConstraint: {
//       distance: 5, // user must move at least 5px
//     },
  ...
  return (
    <Controller
      ...
      rules={{required: 'This is required', 
        validate: (value)=>
          (value.length >= min && value.length <= max) || errorMessage
      }}
      defaultValue={[]}
      render={({ field }) => {
