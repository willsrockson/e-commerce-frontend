...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  return {
    title: `${product.title} - GH₵${product.price.toLocaleString()}`,
    description: `Buy a ${product.condition} ${product.title} for GH₵${product.price} in ${product.town}.`,
    openGraph: {
